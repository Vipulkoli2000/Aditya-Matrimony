...
<?php endif; ?>
            ...
            <?php endif; ?>
            <form method="POST" class="space-y-5" action="<?php echo e(route('password.email')); ?>">
                <?php echo csrf_field(); ?>
                <div>
                    <label for="email">Email</label>
                    <input id="email" name="email" type="email" value="<?php echo e(old('email')); ?>" class="form-input" placeholder="Enter Email" required autofocus />
...
<?php endif; ?>
<?php /**PATH D:\dir\matrimony\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>