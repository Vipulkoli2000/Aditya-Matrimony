...
<?php $component->withAttributes([]); ?>
    ...
    <body>
        <div class="flex-container">
            <form action="<?php echo e(route('profiles.family_details_store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select class="form-input" name="father_is_alive" id="father_is_alive">
                                    ...
                                    <option value="1" <?php echo e($user->father_is_alive === 1 ? 'selected' : ''); ?>>Yes</option>
                                    <option value="0" <?php echo e($user->father_is_alive === 0 ? 'selected' : ''); ?>>No</option>
                                </select>
                                <?php if($errors->has('father_is_alive')): ?>
                                    <span class="text-danger small"><?php echo e($errors->first('father_is_alive')); ?></span>
                                <?php endif; ?>        
                            </div>
                        </div>
                        ...
                        <div class="form-row" id="father_details">
                            ...
                            <div class="form-row"> <!-- Wrapper for the row -->
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-input" name="father_name" value="<?php echo e($user->father_name); ?>" id="father_name" placeholder="Enter Father Name">
                                    <?php if($errors->has('father_name')): ?>
                                        <span class="text-danger small"><?php echo e($errors->first('father_name')); ?></span>
                                    <?php endif; ?>   
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-input" name="father_occupation" id="father_occupation">
                                        <option value="" selected>Select an option</option>
                                        <?php $__currentLoopData = config('data.father_occupation'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value); ?>" <?php echo e(($user->father_occupation === $value) ? 'selected' : ''); ?>><?php echo e($name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php if($errors->has('father_occupation')): ?>
                                        <span class="text-danger small"><?php echo e($errors->first('father_occupation')); ?></span>
                                    <?php endif; ?>   
                                </div>
                            </div>
                            ...
                            <div class="form-row"> <!-- Wrapper for the row -->
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-input" name="father_job_type" id="father_job_type">
                                        <option value="" selected>Select an option</option>
                                        <?php $__currentLoopData = config('data.job_type'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value); ?>" <?php echo e(($user->father_job_type === $value) ? 'selected' : ''); ?> ><?php echo e($name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php if($errors->has('father_job_type')): ?>
                                        <span class="text-danger small"><?php echo e($errors->first('father_job_type')); ?></span>
                                    <?php endif; ?>   
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-input" name="father_organization" value="<?php echo e($user->father_organization); ?>" id="father_organization" placeholder="Enter Organisation Name">
                                    <?php if($errors->has('father_organization')): ?>
                                        <span class="text-danger small"><?php echo e($errors->first('father_organization')); ?></span>
                                    <?php endif; ?>   
                                </div>
                            </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select class="form-input" name="mother_is_alive" id="mother_is_alive">
                                    <option value="" selected>Select an option</option>
                                    <option value="1" <?php echo e($user->mother_is_alive === 1 ? 'selected' : ''); ?>>Yes</option>
                                    <option value="0" <?php echo e($user->mother_is_alive === 0 ? 'selected' : ''); ?>>No</option>
                                </select>
                                <?php if($errors->has('mother_is_alive')): ?>
                                    <span class="text-danger small"><?php echo e($errors->first('mother_is_alive')); ?></span>
                                <?php endif; ?>   
                            </div>
                        </div>
                        ...
                        <div class="form-row" id="mother_details">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-input" name="mother_name" value="<?php echo e($user->mother_name); ?>" id="mother_name" placeholder="Enter Mother Name">
                                    <?php if($errors->has('mother_name')): ?>
                                        <span class="text-danger small"><?php echo e($errors->first('mother_name')); ?></span>
                                    <?php endif; ?>   
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-input" name="mother_occupation" id="mother_occupation">
                                        <option value="" selected>Select an option</option>
                                        <?php $__currentLoopData = config('data.mother_occupation'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value); ?>" <?php echo e(($user->mother_occupation === $value) ? 'selected' : ''); ?>><?php echo e($name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php if($errors->has('mother_occupation')): ?>
                                        <span class="text-danger small"><?php echo e($errors->first('mother_occupation')); ?></span>
                                    <?php endif; ?>   
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-input" name="mother_job_type" id="mother_job_type">
                                        <option value="" selected>Select an option</option>
                                        <?php $__currentLoopData = config('data.job_type'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value); ?>" <?php echo e(($user->mother_job_type === $value) ? 'selected' : ''); ?>><?php echo e($name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php if($errors->has('mother_job_type')): ?>
                                        <span class="text-danger small"><?php echo e($errors->first('mother_job_type')); ?></span>
                                    <?php endif; ?>   
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="mother_organization" value="<?php echo e($user->mother_organization); ?>" id="mother_organization" placeholder="Enter Organization Name">
                                    <?php if($errors->has('mother_organization')): ?>
                                        <span class="text-danger small"><?php echo e($errors->first('mother_organization')); ?></span>
                                    <?php endif; ?>   
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" name="mother_name_before_marriage" value="<?php echo e($user->mother_name_before_marriage); ?>" id="mother_name_before_marriage" placeholder="Enter Mother Name Before Marriage" class="form-control">
                                <?php if($errors->has('mother_name_before_marriage')): ?>
                                    <span class="text-danger small"><?php echo e($errors->first('mother_name_before_marriage')); ?></span>
                                <?php endif; ?>
                            </div>
                            <!-- Native Place Field -->
                            <div class="form-group">
                                <label for="mother_native_place">Native Place</label>
                                <input type="text" name="mother_native_place" value="<?php echo e($user->mother_native_place); ?>" id="mother_native_place" placeholder="Enter Native Place" class="form-control">
                                <?php if($errors->has('mother_native_place')): ?>
                                    <span class="text-danger small"><?php echo e($errors->first('mother_native_place')); ?></span>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-input" name="brother_resident_place"  value="<?php echo e($user->brother_resident_place); ?>" id="brother_resident_place" placeholder="Enter Resident Place" >
                                <?php if($errors->has('brother_resident_place')): ?>
                                <span class="text-danger small"><?php echo e($errors->first('brother_resident_place')); ?></span>
                                <?php endif; ?>             
                            </div>
                             <div class="form-group">
                                ...
                                <select name="number_of_brothers_married" id="number_of_brothers_married" class="form-input">
                                    <option value="" selected>Select an option</option>
                                    <?php for($i = 1; $i <= 10; $i++): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e(($user->number_of_brothers_married == $i) ? 'selected' : ''); ?>><?php echo e($i); ?> <?php echo e($i > 1 ? 'Brothers' : 'Brother'); ?></option>
                                    <?php endfor; ?>
                                </select>
                                <?php if($errors->has('number_of_brothers_married')): ?>
                                <span class="text-danger small"><?php echo e($errors->first('number_of_brothers_married')); ?></span>
                                <?php endif; ?>   
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="number_of_brothers_unmarried" id="number_of_brothers_unmarried" class="form-input">
                                    <option value="" selected>Select an option</option>
                                    <?php for($i = 1; $i <= 10; $i++): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e(($user->number_of_brothers_unmarried == $i) ? 'selected' : ''); ?>><?php echo e($i); ?> <?php echo e($i > 1 ? 'Brothers' : 'Brother'); ?></option>
                                    <?php endfor; ?>
                                </select>
                                <?php if($errors->has('number_of_brothers_unmarried')): ?>
                                <span class="text-danger small"><?php echo e($errors->first('number_of_brothers_unmarried')); ?></span>
                                <?php endif; ?>   
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input class="form-input" name="sister_resident_place"  value="<?php echo e($user->sister_resident_place); ?>" id="sister_resident_place" placeholder="Enter Resident Place" >
                                <?php if($errors->has('sister_resident_place')): ?>
                                <span class="text-danger small"><?php echo e($errors->first('sister_resident_place')); ?></span>
                                <?php endif; ?>   
                             </div>
                             <div class="form-group">
                                ...
                                <select name="number_of_sisters_married" id="number_of_sisters_married" class="form-input">
                                    <option value="" selected>Select an option</option>
                                    <?php for($i = 1; $i <= 10; $i++): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e(($user->number_of_sisters_married == $i) ? 'selected' : ''); ?>><?php echo e($i); ?> <?php echo e($i > 1 ? 'Sisters' : 'Sister'); ?></option>
                                    <?php endfor; ?>
                                </select>
                                <?php if($errors->has('number_of_sisters_married')): ?>
                                <span class="text-danger small"><?php echo e($errors->first('number_of_sisters_married')); ?></span>
                                <?php endif; ?>   
                            </div>
                            <div class="form-group">
                                ...
                                <select name="number_of_sisters_unmarried" id="number_of_sisters_unmarried" class="form-input">
                                    <option value="" selected>Select an option</option>
                                    <?php for($i = 1; $i <= 10; $i++): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e(($user->number_of_sisters_unmarried == $i) ? 'selected' : ''); ?>><?php echo e($i); ?> <?php echo e($i > 1 ? 'Sisters' : 'Sister'); ?></option>
                                    <?php endfor; ?>
                                </select>
                                <?php if($errors->has('number_of_sisters_unmarried')): ?>
                                <span class="text-danger small"><?php echo e($errors->first('number_of_sisters_unmarried')); ?></span>
                                <?php endif; ?>   
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel">
                            <div class="form-group">
                                ...
                                <textarea name="about_parents" id="about_parents" class="form-input" placeholder="Tell us About Parents..." ><?php echo e(old('about_parents', $user->about_parents)); ?></textarea>
                                <?php if($errors->has('about_parents')): ?>
                                <span class="text-danger small"><?php echo e($errors->first('about_parents')); ?></span>
                                <?php endif; ?>   
                            </div>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH D:\dir\Aditya Matrimony\resources\views/default/view/profile/family_details/create.blade.php ENDPATH**/ ?>