    ...
    <nav x-data="sidebar"
        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="<?php echo e(url('/admin/dashboard')); ?>" class="main-logo flex items-center shrink-0">
                <img class="w-8 ml-[5px] flex-none" src="/assets/user/img/favicon.png"
                        alt="image" />
                    <span
                        class="text-xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light"><?php echo e(config('app.name', ' Aditya Matrimony')); ?></span>
                </a>
                <a href="javascript:;"
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li>   
                    <a href="<?php echo e(url('/admin/dashboard')); ?>" class="menu nav-item">
                ...
                <?php if (\Illuminate\Support\Facades\Blade::check('role', ['admin','member'])): ?>
                <li class="menu nav-item">
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'reports'" x-collapse class="sub-menu text-gray-500">
                        ...
                        <li><a href="<?php echo e(route('admin.reports.bride-grooms')); ?>">Bride/Grooms</a></li>
                    </ul>
                </li>
...
<?php /**PATH D:\dir\Aditya Matrimony\resources\views/components/common/sidebar.blade.php ENDPATH**/ ?>