                    ...
                    <nav class="navbar navbar-light navbar-expand-xl py-2" id="navBar">
                        ...
                        <div class="collapse navbar-collapse py-2" id="navbarCollapse">
                            <div class="navbar-nav mx-auto border-top">
                                ...
                                <a href="/about" class="nav-item nav-link <?php echo e(Request::is('about') ? 'active' : ''); ?>">About Us</a>
                                <a href="<?php echo e(route('basic_details.index')); ?>" class="nav-item nav-link <?php echo e(request()->routeIs('basic_details.index') ? 'active' : ''); ?>">Profile</a>
...
<?php /**PATH D:\dir\Aditya Matrimony\resources\views/components/layout/user_banner.blade.php ENDPATH**/ ?>