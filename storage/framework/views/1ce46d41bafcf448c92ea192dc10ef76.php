...
<?php $component->withAttributes([]); ?>
    ...
    <div class="content-wrapper">
        <div class="main-content">
            <h3 class="text-center m-3">Available Tokens: <?php echo e($user->available_tokens); ?></h3>

            <?php if($purchased_packages->isNotEmpty()): ?>
            ...
            <div class="container pl-4">
                <div class="packages-table-container">
                    <table class="packages-table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $purchased_packages->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchased_package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($purchased_package->name); ?></td>
                                <td><?php echo e($purchased_package->description); ?></td>
                                <td>₹<?php echo e(number_format($purchased_package->price, 2)); ?></td>
                                <td><?php echo e($purchased_package->pivot->expires_at); ?></td>
                                <td>
                                    <a href="<?php echo e(route('generate.invoice', $purchased_package->id)); ?>" class="btn btn-secondary btn-sm" target="_blank">
                                    Download Invoice
                                    </a>
                                </td>
                            </tr>
                    ...
                    <?php if($purchased_packages->count() > 3): ?>
                        <div class="view-all-link">
                            <a href="<?php echo e(route('all.purchased.packages')); ?>" class="btn btn-sm btn-link">View All Purchased Packages →</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                        ...
                        <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="package-box">
                                ...
                                <div class="form-group">
                                    <p><strong>Package Description:</strong> <?php echo e($package->description); ?></p>
                                    <p><strong>Package Price:</strong> ₹<?php echo e(number_format($package->price, 2)); ?></p>
...
<?php endif; ?>
    ...
    <form id="purchaseForm" action="<?php echo e(route('purchase_packages.store')); ?>" method="POST" style="display: none;">
        <?php echo csrf_field(); ?>
        ...
        function handlePaymentYes() {
            ...
            var options = {
                ...
                "handler": function (response){
                    ...
                    fetch("<?php echo e(route('razorpay.payment')); ?>", {
                        method: 'POST',
                        headers: {
            ...
            rzp.on('payment.failed', function (response) {
                ...
                fetch("<?php echo e(route('razorpay.failure')); ?>", {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>"
...
const userState = "<?php echo e($user->state ?? ''); ?>";
const userCountry = "<?php echo e($user->country ?? ''); ?>";
...
<?php endif; ?>
<?php /**PATH D:\dir\Aditya Matrimony\resources\views/default/view/profile/user_packages/create.blade.php ENDPATH**/ ?>