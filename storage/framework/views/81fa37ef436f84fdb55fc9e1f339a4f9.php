    ...
    <div class="shadow-sm">
        <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
            ...
            <a href="/" class="main-logo flex items-center shrink-0">
                    <!-- <img class="w-8 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/user/img/favicon.png"
                        alt="image" /> -->
                    <span
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="relative group" @click="toggle()">
                        <span>
                            ...
                            <img
                                src="https://ui-avatars.com/api/?name=<?php echo e(@Auth::user()->name); ?>&rounded=true"
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        ...
                        <form id="logout-form" method="POST" action="<?php echo e(route('logout')); ?>">
                            ...
                            <li class="border-t border-white-light dark:border-white-light/10">
                                <!-- <a href="<?php echo e(route('logout')); ?>" class=" text-danger !py-3" onclick="event.preventDefault(); this.closest('form').submit();"> -->
                                <a href="<?php echo e(route('logout')); ?>" class=" text-danger !py-3" @click="event.preventDefault(); logout();">
...
<?php /**PATH D:\dir\Aditya Matrimony\resources\views/components/common/header.blade.php ENDPATH**/ ?>