                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select name="partner_min_age" id="partner_min_age" class="form-input">
                                                ...
                                                <?php if(config('data.partner_min_age')): ?>
                                                    <?php $__currentLoopData = config('data.partner_min_age'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($value); ?>" <?php echo e(($user->partner_min_age === $value) ? 'selected' : ''); ?> ><?php echo e($name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                            </select>
                                            <?php if($errors->has('partner_min_age')): ?>
                                            <span class="text-danger small"><?php echo e($errors->first('partner_min_age')); ?></span>
                                            <?php endif; ?>  
                                        </div>
                                    </div>
                                    <?php else: ?> 
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select name="partner_min_age" id="partner_min_age" class="form-input">
                                                <option value="" selected>select an option</option>
                                                <?php if(config('data.bride_min_age')): ?>
                                                    <?php $__currentLoopData = config('data.bride_min_age'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($value); ?>" <?php echo e(($user->partner_min_age === $value) ? 'selected' : ''); ?> ><?php echo e($name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                            </select>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select name="partner_max_age" id="partner_max_age" class="form-input">
                                                <option value="" selected>select an option</option>
                                                <?php if(config('data.partner_max_age')): ?>
                                                    <?php $__currentLoopData = config('data.partner_max_age'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($value); ?>" <?php echo e(($user->partner_max_age === $value) ? 'selected' : ''); ?> ><?php echo e($name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                            </select>
                                            <?php if($errors->has('partner_max_age')): ?>
                                            <span class="text-danger small"><?php echo e($errors->first('partner_max_age')); ?></span>
                                            <?php endif; ?>  
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select name="partner_min_height" id="partner_min_height" class="form-input">
                                                <option value="" selected>select an option</option>
                                                <?php if(config('data.partner_min_height')): ?>
                                                    <?php $__currentLoopData = config('data.partner_min_height'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($value); ?>" <?php echo e(($user->partner_min_height === $value) ? 'selected' : ''); ?> ><?php echo e($name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                            </select>
                                            <?php if($errors->has('partner_min_height')): ?>
                                            <span class="text-danger small"><?php echo e($errors->first('partner_min_height')); ?></span>
                                            <?php endif; ?> 
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select name="partner_max_height" id="partner_max_height" class="form-input">
                                                <option value="" selected>select an option</option>
                                                <?php if(config('data.partner_max_height')): ?>
                                                    <?php $__currentLoopData = config('data.partner_max_height'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($value); ?>" <?php echo e(($user->partner_max_height === $value) ? 'selected' : ''); ?> ><?php echo e($name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                            </select>
                                            <?php if($errors->has('partner_max_height')): ?>
                                            <span class="text-danger small"><?php echo e($errors->first('partner_max_height')); ?></span>
                                            <?php endif; ?> 
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="partner_income" value="<?php echo e($user->partner_income); ?>" id="partner_income" placeholder="Enter Native Place">
                                        <?php if($errors->has('partner_income')): ?>
                                            <span class="text-danger small"><?php echo e($errors->first('partner_income')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-input" name="want_to_see_patrika" id="want_to_see_patrika">
                                            <option value="" selected>Select an option</option>
                                            <option value="yes" <?php echo e($user->want_to_see_patrika === 'yes' ? 'selected' : ''); ?>>Yes</option>
                                            <option value="no" <?php echo e($user->want_to_see_patrika === 'no' ? 'selected' : ''); ?>>No</option>
                                        </select>
                                        <?php if($errors->has('want_to_see_patrika')): ?>
                                            <span class="text-danger small"><?php echo e($errors->first('want_to_see_patrika')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-input" name="partner_eating_habbit" id="partner_eating_habbit">
                                            <option value="" selected>Select an option</option>
                                            <?php $__currentLoopData = config('data.partner_eating_habbit', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value); ?>" <?php echo e(($user->partner_eating_habbit === $value) ? 'selected' : ''); ?>><?php echo e($name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <?php if($errors->has('partner_eating_habbit')): ?>
                                            <span class="text-danger small"><?php echo e($errors->first('partner_eating_habbit')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="partner_city_preference" value="<?php echo e($user->partner_city_preference); ?>" id="partner_city_preference" placeholder="Enter City Preference">
                                        <?php if($errors->has('partner_city_preference')): ?>
                                            <span class="text-danger small"><?php echo e($errors->first('partner_city_preference')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="partner_education" value="<?php echo e($user->partner_education); ?>" id="partner_education" placeholder="Enter Education">
                                        <?php if($errors->has('partner_education')): ?>
                                            <span class="text-danger small"><?php echo e($errors->first('partner_education')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-input" name="partner_job" id="partner_job">
                                            <option value="" selected>Select an option</option>
                                            <option value="yes" <?php echo e($user->partner_job === 'yes' ? 'selected' : ''); ?>>Yes</option>
                                            <option value="no" <?php echo e($user->partner_job === 'no' ? 'selected' : ''); ?>>No</option>
                                        </select>
                                        <?php if($errors->has('partner_job')): ?>
                                            <span class="text-danger small"><?php echo e($errors->first('partner_job')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-input" name="partner_business" id="partner_business">
                                            <option value="" selected>Select an option</option>
                                            <option value="yes" <?php echo e($user->partner_business === 'yes' ? 'selected' : ''); ?>>Yes</option>
                                            <option value="no" <?php echo e($user->partner_business === 'no' ? 'selected' : ''); ?>>No</option>
                                        </select>
                                        <?php if($errors->has('partner_business')): ?>
                                            <span class="text-danger small"><?php echo e($errors->first('partner_business')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-input" name="partner_foreign_resident" id="partner_foreign_resident">
                                            <option value="" selected>Select an option</option>
                                            <option value="yes" <?php echo e($user->partner_foreign_resident === 'yes' ? 'selected' : ''); ?>>Yes</option>
                                            <option value="no" <?php echo e($user->partner_foreign_resident === 'no' ? 'selected' : ''); ?>>No</option>
                                        </select>
                                        <?php if($errors->has('partner_foreign_resident')): ?>
                                            <span class="text-danger small"><?php echo e($errors->first('partner_foreign_resident')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
...
<?php endif; ?>
<?php /**PATH D:\dir\Aditya Matrimony\resources\views/default/view/profile/life_partner/create.blade.php ENDPATH**/ ?>