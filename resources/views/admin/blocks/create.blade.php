<x-layout.admin>
    <div>
        ...
        <div class="pt-5">        
            <form class="space-y-5" action="{{ route('blocks.store') }}" method="POST">
                @csrf
                <div class="panel">
                    <div class="flex items-center justify-between mb-5">
                        <h5 class="font-semibold text-lg dark:text-white-light">Add Block</h5>
                    </div>               
                    <div class="grid grid-cols-1 gap-4 mb-4 md:grid-cols-3">     
                        <x-text-input name="block" value="{{ old('block') }}" :label="__('Block Name')" :require="true" :messages="$errors->get('block')"/>                       
                    </div>
